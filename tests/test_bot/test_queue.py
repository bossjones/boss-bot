...
@pytest.mark.asyncio
async def test_show_queue_empty(fixture_mock_bot_test: BossBot, ctx: commands.Context, mocker: MockerFixture) -> None:
...
@pytest.mark.asyncio
async def test_show_queue_with_items(fixture_mock_bot_test: BossBot, ctx: commands.Context, mocker: MockerFixture) -> None:
...
@pytest.mark.asyncio
async def test_show_queue_pagination(fixture_mock_bot_test: BossBot, ctx: commands.Context, mocker: MockerFixture) -> None:
    ...
    assert call_args.description is not None and len(call_args.description.split("\n")) == 5  # 5 items per page
...
@pytest.mark.asyncio
async def test_clear_queue(fixture_mock_bot_test: BossBot, ctx: commands.Context, mocker: MockerFixture) -> None:
...
@pytest.mark.asyncio
async def test_remove_from_queue_success(fixture_mock_bot_test: BossBot, ctx: commands.Context, mocker: MockerFixture) -> None:
...
@pytest.mark.asyncio
async def test_remove_from_queue_not_found(fixture_mock_bot_test: BossBot, ctx: commands.Context, mocker: MockerFixture) -> None:
...
@pytest.mark.asyncio
async def test_pause_queue(fixture_mock_bot_test: BossBot, ctx: commands.Context, mocker: MockerFixture) -> None:
...
@pytest.mark.asyncio
async def test_resume_queue(fixture_mock_bot_test: BossBot, ctx: commands.Context, mocker: MockerFixture) -> None:
